    ...
    >
      ...
      <style>{`
        ...
        @media (max-width: 480px) {
          .soc-card { padding: 14px !important; border-radius: 12px !important; }
          .soc-card-icon { font-size: 22px !important; margin-bottom: 8px !important; }
          .soc-card-name { font-size: 12px !important; margin-bottom: 6px !important; }
          .soc-card-stat { font-size: 20px !important; }
          .soc-card-label { font-size: 9px !important; }
          .soc-card-explore { font-size: 11px !important; margin-top: 10px !important; }
        }
      `}</style>
      ...
      >
        {cards.map((card) => (
          <button
            ...
            className="soc-card text-left rounded-[16px] p-[24px] cursor-pointer"
            style={{
              background: "#0d1b2e",
          ...
          >
            <div className="soc-card-icon" style={{ fontSize: 32, marginBottom: 14 }}>{card.icon}</div>
            <div className="soc-card-name" style={{ color: "#fff", fontWeight: 700, fontSize: 16, marginBottom: 12 }}>
              {card.name}
            </div>
            <div className="soc-card-stat" style={{ color: card.color, fontWeight: 800, fontSize: 28, lineHeight: 1 }}>
              {card.stat}
            </div>
            <div
              className="soc-card-label"
              style={{
            ...
            <div className="soc-card-explore" style={{ marginTop: 16, color: card.color, fontSize: 12, fontWeight: 700 }}>
              Explore →
            </div>
          </button>
        ))}
