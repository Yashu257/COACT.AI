  ...
  return (
    <div style={{ fontFamily: "'Instrument Sans', system-ui, sans-serif" }}>
      ...
      <footer className="sdv-footer">
        <div style={{
          maxWidth: 1440, margin: "0 auto", padding: "48px 56px",
          ...
          <p style={{ fontSize: 15, color: "rgba(255,255,255,0.7)", lineHeight: 1.68, maxWidth: 300, margin: 0 }}>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            {[
              ...
              <a key={icon} href={href} target={href !== "#" ? "_blank" : undefined} rel="noopener noreferrer" style={{
          ...
          <span style={{ fontSize: 13, color: "rgba(255,255,255,0.4)" }}>© 2026 Coact.Co.in, All Rights Reserved.</span>
        </div>
      </footer>
    </div>
  );
